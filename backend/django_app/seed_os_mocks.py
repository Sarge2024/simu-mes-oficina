...
veiculo_101, _ = Ativo.objects.get_or_create(placa="XYZ-9876", defaults={"cliente": cliente1, "versao": versao_gol, "ano_fabricacao": 2020, "chassi": "CHAS101"})
veiculo_104, _ = Ativo.objects.get_or_create(placa="JKL-5566", defaults={"cliente": cliente1, "versao": versao_r450, "ano_fabricacao": 2018, "chassi": "CHAS104"})
veiculo_107, _ = Ativo.objects.get_or_create(placa="DEF-8899", defaults={"cliente": cliente1, "versao": versao_argo, "ano_fabricacao": 2021, "chassi": "CHAS107"})

OrdemServico.objects.get_or_create(id=101, defaults={"veiculo": veiculo_101, "status": StatusOS.EM_DIAGNOSTICO})
OrdemServico.objects.get_or_create(id=104, defaults={"veiculo": veiculo_104, "status": StatusOS.AGUARDANDO_APROVACAO})
OrdemServico.objects.get_or_create(id=107, defaults={"veiculo": veiculo_107, "status": StatusOS.AGUARDANDO_APROVACAO})
