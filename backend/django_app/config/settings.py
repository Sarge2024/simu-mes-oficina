...
# Python path — permite imports cross-app (ex: from core.models import TenantModel)
import sys
...
SECRET_KEY = 'django-insecure-#071ebad901(waw82wscb_kzjv-f0ugrp@e%koer=yj!14(wsd'
